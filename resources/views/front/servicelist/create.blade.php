...
@section('content')
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Servisler <small> Servis Ekle</small></h6>
                        ...
                        <form action="{{ route('servicelist.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">Servis Ismi</label>
                                    <input class="form-control" required name="serviceName" type="text">
                                </div>
