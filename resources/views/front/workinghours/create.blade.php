                        ...
                        <form action="{{ route('workinghours.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">Şu Saatten:</label>
                                    <input class="form-control" required name="from" type="text">
                                </div>

                                <div class="col-md-4 px-3">
                                    <label class=" col-form-label" for="l0">Şu Saate:</label>
                                    <input class="form-control" required name="to" type="text">
                                </div>
